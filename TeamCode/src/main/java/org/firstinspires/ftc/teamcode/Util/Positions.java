...
public enum Positions {
    ...
    RedIntakeTape1End(new Vector2d(55, 15), PI*0.5),
    RedIntakeGate(new Vector2d(60, 10), PI*0.5),
    RedIntakeTape2Start(new Vector2d(30, -8), PI*0.5),
    RedIntakeTape2End(new Vector2d(55, -8), PI*0.5),
    ...
    ParkPositionsRed(new Vector2d(53, 15), PI*0.25),
    TurningRed(new Vector2d(0,  90), PI*0.25),
    NewTurningRed(new Vector2d(8,-33), PI*0.1),
    ...
    ShootingInTriangleRed(new Vector2d(52.5, 30), -0.25),
    ParkPositionsRedIn(new Vector2d(45, 25), PI*0.0),
    ...
    BlueIntakeTape1Start(new Vector2d(-20, 10), PI*-0.5),
    BlueIntakeTape1End(new Vector2d(-47.5, 10), PI*-0.5),
    BlueIntakeGate(new Vector2d(-47.5, 0), PI*-0.5),
    BlueIntakeTape2Start(new Vector2d(-20, -15), PI*-0.5),
    BlueIntakeTape2End(new Vector2d(-45, -15), PI*-0.5),
    BlueIntakeFarTape2Start(new Vector2d(-15, -2), PI*-0.5),
    BlueIntakeFarTape2End(new Vector2d(-37, -2), PI*-0.5),
    ...
    GoalShootingBlueTriangle(new Vector2d(-20, 45), PI*-.5),
    ShootingInTriangleBlue(new Vector2d(-52.5, 30), 0.25),
    ParkPositionsBlueIn(new Vector2d(-45, 25), PI*0.0),

    MoveForward(new Vector2d(30,  0), 0.0),
    NewMoveForward(new Vector2d(12,  -46), 0.0),

    Test(new Vector2d(23.0,0.0),0.0),
    Test2(new Vector2d(-23,0),0.0),
